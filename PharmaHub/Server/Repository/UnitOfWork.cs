...
using PharmaHub.Client.Pages;
using static NuGet.Packaging.PackagingConstants;

namespace PharmaHub.Server.Repository
{
    public class UnitOfWork : IUnitOfWork
    {
        ...
        private IGenericRepository<ProductPrescription> _productPrescriptions;
        private IGenericRepository<Staff> _staffMembers;
        ...
        public IGenericRepository<ProductPrescription> ProductPrescriptions
            => _productPrescriptions ??= new GenericRepository<ProductPrescription>(_context);

        public IGenericRepository<Staff> StaffMembers
            => _staffMembers ??= new GenericRepository<Staff>(_context);
